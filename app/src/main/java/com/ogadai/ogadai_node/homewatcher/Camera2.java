...
public class Camera2 implements CameraControls {
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                mOpenGLSurface = new OpenGLSurface(mPreviewSize.getWidth(), mPreviewSize.getHeight());
    ...
    private void createCameraPreviewSession() {
        try {
            ...
            Surface surface = mOpenGLSurface.getSurface();
